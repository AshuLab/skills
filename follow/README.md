...
Skills that work on **the conversation itself** rather than on the work. They differ
by reach and by reader - one message or the whole thing, you or the agent that comes
after you. Nothing here touches your repo.
...
- **Shorter or it failed.** Both skills are judged against the length of what they
  replace.
