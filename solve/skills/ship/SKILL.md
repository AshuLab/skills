...
**The next startable slice(s)** is every slice **of this epic** that's open, unblocked (every blocker done), unclaimed - `docs/agents/solve.md` -> **Tracker operations** has how to get the set. Absent that file, infer github still (`owner/repo` from the git remote) and use the operation below.
